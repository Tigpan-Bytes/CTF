    ...
    <div class='challenge-holder'>
        <div class='portion-holder'>
            ...
            <div class='underline'>
                ...
                <p>&emsp;&emsp;"Hey buddy, meet me behind <a href="<?php echo $_SESSION['redir']?>challenge-site/Secret-Deal.py" download>this</a> location tonight. 
                A hacker of your caliber should have no problem finding me." - Unknown.</p>
             </div>
